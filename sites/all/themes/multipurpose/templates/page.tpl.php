      ...
      <div id="header-social" class="clr">
        <ul>
          <?php if ($facebook_url): ?><li>
            <a target="_blank" title="<?php print $site_name; ?> na Facebook" href="<?php print $facebook_url; ?>"><img alt="Facebook" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/facebook.png'; ?>"> </a>
          </li><?php endif; ?>
          <?php if ($twitter_url): ?><li>
            <a target="_blank" title="<?php print $site_name; ?> na Twitter" href="<?php print $twitter_url; ?>"><img alt="Twitter" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/twitter.png'; ?>"> </a>
          </li><?php endif; ?>
          <?php if ($youtube_url): ?><li>
            <a target="_blank" title="<?php print $site_name; ?> na Youtube" href="<?php print $youtube_url; ?>"><img alt="Google+" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/youtube.png'; ?>"> </a>
          </li><?php endif; ?>
          <?php if ($instagram_url): ?><li>
            <a target="_blank" title="<?php print $site_name; ?> na Instagram" href="<?php print $instagram_url; ?>"><img alt="Pinterest" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/instagram.png'; ?>"> </a>
          </li><?php endif; ?>
        </ul>
      </div>
      <?php endif; ?>
