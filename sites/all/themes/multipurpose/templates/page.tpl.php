        ...
        <header id="header">
          <div id="site-info">
            <?php if ($logo): ?>
              <div id="site-logo">
                <?php
                $logo = base_path() . drupal_get_path('theme', 'multipurpose') . '/images/logo-70.svg';
                $logo_fall = base_path() . drupal_get_path('theme', 'multipurpose') . '/images/logo-70.png';
                ?>
                <a href="<?php print $front_page; ?>" title="<?php print $site_name; ?>">
                  <img src="<?php print $logo; ?>" alt="<?php print $site_name; ?>"  onerror="this.src='<?php print $logo_fall; ?>'; this.onerror=null;" />
                </a>
              </div>
            <?php endif; ?>
